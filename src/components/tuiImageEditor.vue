<template>
  <div>
    <ImageEditor id="test" :options="options"></ImageEditor>
    <n-button @click="uploadEditImg">点击</n-button>
  </div>
</template>
...
export default defineComponent({
  ...
  setup(props,ctx) {
    let useDefaultUI = reactive(true)
    ...
    let options = reactive({
      includeUI: {
        ...
        loadImage: {
          // 图片路径
          path: "https://cdn.pixabay.com/photo/2013/05/12/18/55/balance-110850_960_720.jpg",
          // 图片的名字，可以省略
          name: "sample",
        },
        locale: locale_zh,//语言
    ...
    return {
      options, useDefaultUI,uploadEditImg
    }
